...
const (
	...
	ProductService_ListProduct_FullMethodName   = "/api.product.v1.ProductService/ListProduct"
	ProductService_DeductStock_FullMethodName   = "/api.product.v1.ProductService/DeductStock"
	ProductService_RestoreStock_FullMethodName  = "/api.product.v1.ProductService/RestoreStock"
)
...
type ProductServiceClient interface {
	...
	DeductStock(ctx context.Context, in *DeductStockRequest, opts ...grpc.CallOption) (*DeductStockReply, error)
	RestoreStock(ctx context.Context, in *RestoreStockRequest, opts ...grpc.CallOption) (*DeductStockReply, error)
}
...
func (c *productServiceClient) DeductStock(ctx context.Context, in *DeductStockRequest, opts ...grpc.CallOption) (*DeductStockReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeductStockReply)
...
func (c *productServiceClient) RestoreStock(ctx context.Context, in *RestoreStockRequest, opts ...grpc.CallOption) (*DeductStockReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeductStockReply)
...
type ProductServiceServer interface {
	...
	DeductStock(context.Context, *DeductStockRequest) (*DeductStockReply, error)
	RestoreStock(context.Context, *RestoreStockRequest) (*DeductStockReply, error)
...
func (UnimplementedProductServiceServer) DeductStock(context.Context, *DeductStockRequest) (*DeductStockReply, error) {
	return nil, status.Error(codes.Unimplemented, "method DeductStock not implemented")
}
func (UnimplementedProductServiceServer) RestoreStock(context.Context, *RestoreStockRequest) (*DeductStockReply, error) {

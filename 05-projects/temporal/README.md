...
│   ├── 02-getting-started-order-processing/
│   ├── 03-advanced-distributed-order/
│   └── 04-expert-ecommerce-workflow/
├── hands-on/               # 动手练习代码
└── example/                # 完整示例应用
```
...
### 实战路径
完成理论学习后 → projects/01-getting-started-helloworld → projects/02-getting-started-order-processing → ...

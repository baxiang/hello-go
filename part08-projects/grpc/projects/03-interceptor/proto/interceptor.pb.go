...
const file_proto_interceptor_proto_rawDesc = "" +
	"\n" +
	"\x17proto/interceptor.proto\x12\vinterceptor\"\"\n" +
	...
	"\aGreeter\x12>\n" +
	"\bSayHello\x12\x19.interceptor.HelloRequest\x1a\x17.interceptor.HelloReplyB\x15Z\x13./proto;interceptorb\x06proto3"
...
var file_proto_interceptor_proto_depIdxs = []int32{
	0, // 0: interceptor.Greeter.SayHello:input_type -> interceptor.HelloRequest
	1, // 1: interceptor.Greeter.SayHello:output_type -> interceptor.HelloReply

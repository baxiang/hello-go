...
const (
	...
	PaymentService_GetPayment_FullMethodName      = "/api.payment.v1.PaymentService/GetPayment"
	PaymentService_PaymentCallback_FullMethodName = "/api.payment.v1.PaymentService/PaymentCallback"
)
...
type PaymentServiceClient interface {
	...
	PaymentCallback(ctx context.Context, in *PaymentCallbackRequest, opts ...grpc.CallOption) (*Payment, error)
}
...
func (c *paymentServiceClient) PaymentCallback(ctx context.Context, in *PaymentCallbackRequest, opts ...grpc.CallOption) (*Payment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Payment)
...
type PaymentServiceServer interface {
	...
	PaymentCallback(context.Context, *PaymentCallbackRequest) (*Payment, error)
...
func (UnimplementedPaymentServiceServer) PaymentCallback(context.Context, *PaymentCallbackRequest) (*Payment, error) {

...
func main() {
	...
	orderService := service.NewOrderService(orderUC)
	orderV1.RegisterOrderServiceHTTPServer(httpServer, orderService)
...
func loadConfig() *config.Config {
	...
	if path == "" {
		path = "configs/order-service.yaml"
	}
